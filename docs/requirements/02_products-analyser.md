...
- **Column 1 — Product selector:** free-text input that narrows the list from the products database as the user types.
...
- **Flag columns:** "This week" and "Next week" — toggles that mark whether the product is planned for the respective week (mirrored with the All products view).
